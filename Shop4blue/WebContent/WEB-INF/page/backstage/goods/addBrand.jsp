...
<div>
    <form id="addform" class="add1-1" action="${pageContext.request.contextPath}/brand/showBrands?rows=${rows }&flag=add" method="post">
        <div class="line">
            <div class="line-1">*名称:&nbsp&nbsp</div>
            <input required="ture" class="input" type="text" name="name" value="" />
        </div>
        <div class="line">
        ...
        <div class="line">
            ...
            <input type="text" id="filepath" class="input"  name="logo"/>
        ...
        <div class="line">
            ...
            <input type="text" id="url" class="input" name="url"/>
        </div>
        <div class="line">
            <div class="line-1">排序:&nbsp&nbsp</div>
            <input type="text" class="input" name="orders"/>
        </div>
        <div class="line-b">
