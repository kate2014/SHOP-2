...
<title>订单打印 - Powered By SHOP++</title>
	...
	<div class="content">
		<table>
			...
			<tr class="separated">
				...
				<td colspan="3">
					商品价格: ￥<fmt:formatNumber maxFractionDigits="4" minFractionDigits="2" value="${totalMoney }"/><br />
					支付手续费: ￥<fmt:formatNumber maxFractionDigits="4" minFractionDigits="2" value="${order.fee }"/><br />
					运费: ￥<fmt:formatNumber maxFractionDigits="4" minFractionDigits="2" value="${order.freight }"/><br />
					订单金额: ￥<fmt:formatNumber maxFractionDigits="4" minFractionDigits="2" value="${order.freight+order.fee+totalMoney }"/>
				</td>
			</tr>
			<tr>
				<td colspan="6">
