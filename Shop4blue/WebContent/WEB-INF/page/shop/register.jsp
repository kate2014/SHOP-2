...
<link href="${pageContext.request.contextPath }/resources/shop/css/register.css" rel="stylesheet" type="text/css" />
	...
	$registerForm.validate({
		rules: {
			username: {
				...
				minlength: 2,
				remote: {
					url: "${pageContext.request.contextPath }/proRegister/seeUserName",
					type: "POST",
    				data: {
			...
			email: {
				...
				email: true
					,remote: {
						url: "${pageContext.request.contextPath }/proRegister/seeEmail",
						type: "POST",
	    				data: {
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/proRegister/realRegister" method="post">
						<table>
							<tr>
								<th>
								...
								<td>
									...
									<tr>
									 <th>
										...
										<td>
												<input type="text" name="czx" class="text" onfocus="WdatePicker();" 
...
/>
								...
								<%-- <tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath }/identity/iden" title="点击更换验证码" />
										</span>
									</td>
								</tr> --%>
							<tr>
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="/shopxx/login.jhtml">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
