...
$(function(){
	$("#selCount").change(function(){
		   ...
		   alert(size);
		    location.href="${pageContext.request.contextPath}/orderReturns/checkReturnsBySize?rows="+size+"&page="+${page.page};  
		})
	$("#del").click(function(){
		var str="";
		...
		alert(str);
	 	 $.post("${pageContext.request.contextPath}/orderReturns/delReturns",{"str":str,"page":"${page.page}","size":"${page.size}"},function(page){
...
<div id="bodyer">
    ...
    <table>
      ...
      <tr>
            ...
            <td><a href="${pageContext.request.contextPath }/orderReturns/returnsDetails?id=${l.id}">[查看]</a></td>
        </tr>
      </c:forEach>
    </table>
   <itcast:page url="${pageContext.request.contextPath }/orderReturns/checkReturnsBySize"/>
</div>
</body>
</html>