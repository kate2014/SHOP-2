...
public class XxShipping {
    ...
    private List<XxShippingItem> xsi;
    
    private List<XxShippingItem> shippingItems;
    

    

	public List<XxShippingItem> getShippingItems() {
		return shippingItems;
	}

	public void setShippingItems(List<XxShippingItem> shippingItems) {
		this.shippingItems = shippingItems;
	}

	public List<XxShippingItem> getXsi() {
		return xsi;
	}

	public void setXsi(List<XxShippingItem> xsi) {
		this.xsi = xsi;
	}
