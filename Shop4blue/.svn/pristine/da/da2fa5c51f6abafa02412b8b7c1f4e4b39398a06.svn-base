...
<div id="bodyer">
    ...
    <div class="btn-group">
        ...
        <a  href="${pageContext.request.contextPath}/consult?rows=${rows }" class="btn btn-default"><span id="shuaxin"></span>刷新</a>
    ...
    <form id="delMe" action="${pageContext.request.contextPath}/consult?rows=${rows }" method="post">
...
<script type="text/javascript">
  $(function(){
      ...
      $("#paggingShow").hover(function(e){
    	  ...
    	  var div=$("<div class='divsw' ><div class='page'><a href='${pageContext.request.contextPath}/consult?rows=5'>5</a></div><div class='page'><a href='${pageContext.request.contextPath}/consult?rows=10'>10</a></div><div class='page'><a href='${pageContext.request.contextPath}/consult?rows=20'>20</a></div></div>");
