...
<body>
	...
	<form id="inputForm" action="${pageContext.request.contextPath}/orderExpressModel/addExpress" method="post" enctype="multipart/form-date">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="background" name="background" class="text" maxlength="200"  readonly="readonly"/>
