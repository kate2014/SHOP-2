...
/*	$("#sub").click(function(){
		alert($("#name").val());
		$.post("${pageContext.request.contextPath}/memberRank/getuser",{name:$("#name").val()},function(){});
	})*/
...
<body>
	...
	<form id="inputForm" action="${pageContext.request.contextPath}/memberRank/getuser"   method="post">
		<table class="input">
			<tr>
				<th>
				...
				<td>
					<input type="text" name="name" id="name" class="text" maxlength="100" />
				</td>
			</tr>
			<tr>
				<th>
